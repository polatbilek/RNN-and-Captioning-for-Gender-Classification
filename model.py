...
class network(object):
    ...
    def __init__(self, embeddings):
        ...
        self.tf_embeddings = tf.Variable(tf.constant(0.0, shape=[embeddings.shape[0], embeddings.shape[1]]),
                                         trainable=False, name="tf_embeddings")
        ...
        self.embedding_init = self.tf_embeddings.assign(
            self.embedding_placeholder)  # initialize this once when the session begins with sess.run
